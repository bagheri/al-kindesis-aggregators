...
public class JsonDataExtractor extends AbstractDataExtractor implements IDataExtractor {
     ...
     * for the stream item.
     * 
     * @param dateValueAttribute The attribute name which contains the date
     *        item.
     * @return
     */
     ...
     * 
     * @param summaryAttributes List of summary attribute names or expressions
     *        which should be extracted from the data
     * @return
    ...
    public void validate() throws Exception {
        ...
        if (this.aggregatorType.equals(AggregatorType.SUM) && this.summaryAttributes == null) {
            throw new InvalidConfigurationException(
